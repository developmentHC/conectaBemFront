    ...
    <main className="flex w-full justify-center">
      <div className="flex w-full flex-col gap-8 md:max-w-[450px]">
        ...
        <div className="flex flex-col gap-6">
          <Button className="w-full text-black" variant="outlined" onClick={handleOpen}>
            Paciente
          </Button>
          <Link href={"/auth/registro-profissional"}>
            <Button className="w-full text-black" variant="outlined">
              Profissional
            </Button>
          </Link>
        </div>
      ...
      >
        <Box sx={style}>
          ...
          <Box
            sx={{ display: "flex", flexDirection: "column", gap: "12px", width: "100%", mt: "8px" }}
          >
