...
import { AppointmentPatientCard, type PatientAppointmentStatus } from "./AppointmentPatientCard";
...
function formatAddressLine(a: IAppointment) {
  ...
  const addr = Array.isArray(a.address)
    ? (a.address.find((x: any) => x?.active) ?? a.address[0])
    : (a.address as any);
            ...
            return (
              <AppointmentPatientCard
                ...
                professional={{
                  ...
                  imageUrl:
                    (a.professional as any)?.profileImageUrl ??
                    (a.professional as any)?.image ??
                    null,
                }}
