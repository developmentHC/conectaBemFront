          ...
          return (
            ...
            >
              ...
              <div className="w-[60px] flex justify-end pt-2 pr-2">
                <span
                  className={`text-[16px] md:text-[18px] font-semibold transition-colors duration-150 ${
              ...
              <div className="relative w-[24px] flex justify-center">
                ...
                <span
                  className={`w-[12px] h-[12px] rounded-full translate-x-[8px] mt-[10px] z-10 transition-all duration-200 ${
                    activeTime === time ? "bg-[#0B29C1] scale-110" : "bg-[#9790A2] scale-100"
                  }`}
                />
              </div>
