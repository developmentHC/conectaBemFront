...
export const FilterDialogDesktop = ({
  ...
  const [selectedDistance, setSelectedDistance] = useState<number>(filters.distance || 0);
  const [selectedSpecialty, setSelectedSpecialty] = useState<string[]>(filters.specialty || []);
